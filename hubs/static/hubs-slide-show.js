function inject_slideshow_Media() {
  AFRAME.registerComponent("slidemenu-pager", {
    ...
    init() {
      ...
      this.el.setAttribute("hover-menu__pager", {
        template: "#slidepager-hover-menu",
        isFlat: true,
      });
      ...
      NAF.utils
        ...
        .then((networkedEl) => {
          ...
          this.data.index =
            this.networkedEl.getAttribute("slide-element").index;
        })
    ...
    async update(oldData) {
      if (this.networkedEl && NAF.utils.isMine(this.networkedEl)) {
        if (
          oldData &&
          typeof oldData.index === "number" &&
          oldData.index !== this.data.index
        ) {
      ...
      if (this.prevButton && this.nextButton) {
        const pinnableElement =
          this.el.components["media-loader"].data.linkedEl || this.el;
        const isPinned =
          pinnableElement.components.pinnable &&
          pinnableElement.components.pinnable.data.pinned;
  ...
  AFRAME.registerComponent("slide-element", {
    ...
    async update(oldData) {
      ...
      this.el.setAttribute("media-loader", {
        src: this.content[this.currentSlide],
        fitToBox: true,
        resolve: false,
      });
      ...
      if (this.networkedEl && NAF.utils.isMine(this.networkedEl)) {
        if (
          ...
          this.networkedEl.setAttribute("slide-element", {
